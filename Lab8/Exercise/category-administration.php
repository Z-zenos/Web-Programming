...
<body>
  ...
  <?php
    try {
      ...
      print("<p>Number of categories: <span style='color: limegreen; font-size: 20px; font-weight: bold'>$res->num_rows</span></p>");
  ...
  <?php
    ...
    if($submitted) {
      ...
      if(count($errors) > 0) {
        print('<p style="color: red">Errors:</p>' . implode(array_map(fn($e) => "<p style='color: red'>- $e</p>", $errors)));
      }
